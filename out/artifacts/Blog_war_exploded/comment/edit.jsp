...
<div>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <h3 class="navbar-brand" href="#">Edit Comment</h3>
    </nav><br>
</div>
<p>
    ...
    <fieldset>
        ...
        <table>
            <%--            <tr>
                ...
                <tr>
                    <td>Title Post:</td>
                    <td><a type="text" name="postTitle" id="postTitle"
                           value="">${requestScope["comment"].getTitlePost()}</a></td>
                </tr>
            <td>Contents:</td>
            <td><input type="text" name="contents" id="contents" value="${requestScope["comment"].getContents()}"></td>
            </tr>
            <%--            <tr>
                            <td>Id Post: </td>
                            <td><a type="text" name="idPosts" id="idPosts" value="">${requestScope["comment"].getIdPosts()}</a></td>
                        </tr>--%>
            <tr>
                <td>Username:</td>
                <td><a type="text" name="username" id="username" value="">${requestScope["comment"].getUsername()}</a>
                </td>
            </tr>
            <tr>
                <td>User Password:</td>
            ...
            <tr>
                <td></td>
                <td><input style="margin-left: 13px;margin-top: 11px;" class="btn btn-success" type="submit" value="Update Comment"></td>
            </tr>
        </table>
    </fieldset>
    <%
