            ...
            <article class="entry">
                ...
                <header class="entry-header">
                    ...
                    <h2 class="entry-title">
                        <a href="/home?action=${post.getNameCategories()}"
                           title="">${post.getNameCategories()}</a>
                    </h2>
                ...
                <div class="entry-content">
                    <h5><a href="/posts?action=view&id=${post.getId()}">
                            ${post.getTitle()}</a>
...
<footer>
    ...
    <div class="row">
        ...
        <div class="six columns info">
            ...
            <p>Mục đích trang web này nhằm nâng cao khả năng code thuần Java và tăng khả năng làm việc nhóm
            </p>
